    ...
    <div class="row mb-3">
        ...
        <div class="col-sm">
            <fieldset>
                ...
                Bem-vindo <strong><?= LoginController::getNameOfUser()?></strong> | <a class="btn btn-primary btn-dark" href="/sair">Sair</a> 
            </fieldset>
        </div> 
    </div>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/marca">Listar Marcas</a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/produto">Listar Produtos</a></li>
                    </div>
                </li>
            </ul>
        </div>
